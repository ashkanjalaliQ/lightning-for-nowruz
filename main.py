...
arg_parser.add_argument("-p", "--provider", help='provider of the lnurl, current providers: "lnbits" and "lntxbot"', default="lnbits")
args = arg_parser.parse_args()

postal_card = PostalCard(name=args.name, theme=args.theme)
lnurl = postal_card.create_lnurl(reward=REWARD, provider=args.provider)
